/**
 * 3D 空间歌词渲染。
 * 把歌词以弧形排布在场景中的封面屏幕旁，并按播放进度高亮当前行、平滑滚动。
 * 文件顶部导出的常量定义了封面屏幕与歌词弧面的位置/朝向。
 */
...
import {
  ...
  wrapLyricTextLines,
} from '../../lib/lyrics/lyricLineWrapping';
import { parseLRC } from '../../lib/lyrics/lyrics';
import { type LyricStyleConfig } from '../../lib/settings/lyricsSettings';
