/**
 * 时钟与番茄钟显示。
 * 在画面上显示当前时间，并提供 15/30/45/60 分钟的番茄计时器，
 * 以环形进度展示剩余时间，结束时闪烁提示。
 */
import { createPortal } from 'react-dom';
import React, { useCallback, useEffect, useRef, useState } from 'react';
import type { ClockSettings } from '../../../lib/settings/displaySettings';
 ...
 * 桌面时钟 + 番茄计时器。
 *
 * @param settings 时钟显示设置（显隐、格式、计时器参数等）
 * @param accentHex 主题强调色，用于环形进度与高亮
 */
